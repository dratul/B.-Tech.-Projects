...
{\bfseries\mdseries\titlerule*[0.65em]{.}\contentspage}% <filler-page-format>
...
% For capitalizing first letter of each title
\usepackage{titlecaps} % For capitalizing 

\usepackage{array}

%%New Commands 
\newcommand{\mytitle}{Enhanced Depression Detection using Machine Learning with Real time ECG signals }
\newcommand{\myname}{Avinash Maurya 2004331021 }


% first letter of each title
 \let \svsection \section
 \Addlcwords{is for an of or on and} % Exempted 
 % For capitalizing first letter of each subsection
 \let \svsubsection \subsection
 \Addlcwords{is for an of or on and to} % These words will not be automatically capitalize  
